...
OOF_preds <- rbind(
  ...
  data.frame(lm_best_OOF_preds_spatial_deographic %>% dplyr::select(.pred,turnout_ratio),model = "Model-1d_Linear Regression spatial demographic"),
...
lm_res_adj_spatial_moran_final
...
lm_res_ids_spatial_moran_final
...
lm_res_ids2_spatial_moran_final
...
lm_res_expdis_spatial_moran_final
...
```{r}
# Show residual plot using inverse distance matrix and with spatial cross validation
lm_res_ids_spatial_moran_economic
...
```{r}
# Show residual plot using inverse distance matrix and with spatial cross validation
lm_res_ids_spatial_moran_demographic
...
```{r}
# Show residual plot using inverse distance matrix and with spatial cross validation
lm_res_ids_spatial_moran_location
