...
# Without spatial cross validation
# Composite of best predictors
rf_model_final <- lm_val_fit_geo_final %>% pluck(".workflow", 1) %>% extract_fit_engine() 
tidy(rf_model_final)
augment(rf_model_final)
glance(rf_model_final)
```
...
# With spatial cross validation
# Composite of best predictors
rf_model_spatial_final <- lm_val_fit_geo_spatial_final %>% pluck(".workflow", 1) %>% extract_fit_engine() 
tidy(rf_model_spatial_final)
augment(rf_model_spatial_final)
glance(rf_model_spatial_final)
```
...
# With spatial cross validation
# Socio-economic
rf_model_spatial_economic <- lm_val_fit_geo_spatial_economic %>% pluck(".workflow", 1) %>% extract_fit_engine() 
tidy(rf_model_spatial_economic)
augment(rf_model_spatial_economic)
glance(rf_model_spatial_economic)
```
...
# With spatial cross validation
# Socio-demographic
rf_model_spatial_demographic <- lm_val_fit_geo_spatial_demographic %>% pluck(".workflow", 1) %>% extract_fit_engine() 
tidy(rf_model_spatial_demographic)
augment(rf_model_spatial_demographic)
glance(rf_model_spatial_demographic)
```
...
# With spatial cross validation
# Spatial location
rf_model_spatial_location <- lm_val_fit_geo_spatial_location %>% pluck(".workflow", 1) %>% extract_fit_engine() 
tidy(rf_model_spatial_location)
augment(rf_model_spatial_location)
glance(rf_model_spatial_location)
```
...
vip::vip(num_features = 15, idth = 0.5, aesthetics = list(fill = "purple2"), include_type = T) 
```
...
# With spatial cross-validation
# Composite of best predictors
rf_val_fit_geo_spatial_final %>% pluck(".workflow", 1) %>% extract_fit_parsnip() %>% vip::vip(num_features = 15, idth = 0.5, aesthetics = list(fill = "purple2"), include_type = T) 
```
...
# With spatial cross-validation
# Socio-economic
rf_val_fit_geo_spatial_economic %>% pluck(".workflow", 1) %>% extract_fit_parsnip() %>% vip::vip(num_features = 3, idth = 0.5, aesthetics = list(fill = "purple2"), include_type = T) 
```
...
# With spatial cross-validation
# Socio-demographic
rf_val_fit_geo_spatial_demographic %>% pluck(".workflow", 1) %>% extract_fit_parsnip() %>% vip::vip(num_features = 8, idth = 0.5, aesthetics = list(fill = "purple2"), include_type = T) 
```
...
# With spatial cross-validation
# Spatial location
rf_val_fit_geo_spatial_location %>% pluck(".workflow", 1) %>% extract_fit_parsnip() %>% vip::vip(num_features = 4, idth = 0.5, aesthetics = list(fill = "purple2"), include_type = T) 
```