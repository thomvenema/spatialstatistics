...
lm_lst <- lm_cross_validation(lm_plan=lm_plan, model_recipe=model_rec_final, cv_folds=cv_splits)
...
lm_lst_spatial <- lm_cross_validation(lm_plan=lm_plan, model_recipe=model_rec_final, cv_folds=cv_spatial_folds)
...
rf_lst <- rf_cross_validation(rf_plan=rf_plan, rf_grid=rf_grid, model_recipe=model_rec_final, cv_folds=cv_splits)
...
rf_lst_spatial <- rf_cross_validation(rf_plan=rf_plan, rf_grid=rf_grid, model_recipe=model_rec_final, cv_folds=cv_spatial_folds)
...
for (i in 1:length(lst_final_str)){
  ...
  gwr_lst_coef_final_gauss[[i]] <- gwr_lst_final_gauss[[1]] # TODO: make sure to add all to list
...
for (i in 1:length(lst_final_str)){
  ...
  gwr_lst_coef_final_bisquare[[i]] <- gwr_lst_final_bisquare[[1]] # TODO: make sure to add all to list
...
for (i in 1:length(lst_economic_str)){
  ...
  gwr_lst_coef_economic_gauss[[i]] <- gwr_lst_economic_gauss[[1]] # TODO: make sure to add all to list
...
for (i in 1:length(lst_economic_str)){
  ...
  gwr_lst_coef_economic_bisquare[[i]] <- gwr_lst_economic_bisquare[[1]] # TODO: make sure to add all to list
...
for (i in 1:length(lst_demographic_str)){
  ...
  gwr_lst_coef_demographic_gauss[[i]] <- gwr_lst_demographic_gauss[[1]] # TODO: make sure to add all to list
...
for (i in 1:length(lst_demographic_str)){
  ...
  gwr_lst_coef_demographic_bisquare[[i]] <- gwr_lst_demographic_bisquare[[1]] # TODO: make sure to add all to list
...
for (i in 1:length(lst_location_str)){
  ...
  gwr_lst_coef_location_gauss[[i]] <- gwr_lst_location_gauss[[1]] # TODO: make sure to add all to list
...
for (i in 1:length(lst_location_str)){
  ...
  gwr_lst_coef_location_bisquare[[i]] <- gwr_lst_location_bisquare[[1]] # TODO: make sure to add all to list
...
for (i in 1:length(gwr_lst_coef_final_gauss)){
  gwr_lst_coef_final_gauss[i]
  gwr_lst_sig_final_gauss[i]
}
```

```{r}
for (i in 1:length(gwr_lst_coef_final_bisquare)){
  gwr_lst_coef_final_bisquare[i]
  gwr_lst_sig_final_bisquare[i]
}
```
...
for (i in 1:length(gwr_lst_coef_economic_gauss)){
  gwr_lst_coef_economic_gauss[i]
  gwr_lst_sig_economic_gauss[i]
}
```

```{r}
for (i in 1:length(gwr_lst_coef_economic_bisquare)){
  gwr_lst_coef_economic_bisquare[i]
  gwr_lst_sig_economic_bisquare[i]
}
```
...
for (i in 1:length(gwr_lst_coef_demographic_gauss)){
  gwr_lst_coef_demographic_gauss[i]
  gwr_lst_sig_demographic_gauss[i]
}
```

```{r}
for (i in 1:length(gwr_lst_coef_demographic_bisquare)){
  gwr_lst_coef_demographic_bisquare[i]
  gwr_lst_sig_demographic_bisquare[i]
}
```
...
for (i in 1:length(gwr_lst_coef_location_gauss)){
  gwr_lst_coef_location_gauss[i]
  gwr_lst_sig_location_gauss[i]
}
```

```{r}
for (i in 1:length(gwr_lst_coef_location_bisquare)){
  gwr_lst_coef_location_bisquare[i]
  gwr_lst_sig_location_bisquare[i]
}
```
